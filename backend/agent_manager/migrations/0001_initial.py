    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Scadenza chiave (null = mai)", null=True
                    ),
                ),
                (
                    "created_by",
                    models.CharField(
                        help_text="Utente che ha creato la chiave", max_length=100
                    ),
                ),
                (
                    "last_used_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "websocket_channel",
                    models.CharField(
                        help_text="Django Channels channel name", max_length=255
                    ),
                ),
                (
                    "is_online",
                    models.BooleanField(
                        db_index=True, default=True, help_text="Agent connesso e attivo"
                    ),
                ),
                (
                    "last_heartbeat",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phase_1_verified",
                    models.BooleanField(default=False, help_text="API key verificata"),
                ),
                (
                    "phase_2_verified",
                    models.BooleanField(
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        blank=True, help_text="IP ricevuto dall'agent", null=True
                    ),
                ),
                (
                    "agent_hostname",
                ...
                (
                    "expires_at",
                    models.DateTimeField(help_text="Scadenza sessione (3 minuti)"),
                ),
                (
                    "completed_at",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result",
                    models.JSONField(
                        blank=True, help_text="Risultato esecuzione comando", null=True
                    ),
                ),
                (
                    "error_message",
                    models.TextField(blank=True, help_text="Messaggio di errore"),
                ),
                (
                    "timeout_seconds",
                    models.PositiveIntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "raw_data",
                    models.JSONField(
                        blank=True, help_text="Dati completi heartbeat", null=True
                    ),
                ),
                (
                    "target",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="agent_manag_target__be72fd_idx",
                    )
                ],
            },
        ),
