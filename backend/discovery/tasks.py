...
def discover_network_task(self):
    ...
    try:
        ...
        if all_discovered:
            DiscoveredHost.objects.exclude(
                id__in=all_discovered
    ...
    try:
        ...
        for line in result.stdout.split('\n'):
            ...
            if match:
                ...
                if not network.startswith('0.0.0.0') and \
                   not network.startswith('127.') and \
                   not network.startswith('169.254.'):
