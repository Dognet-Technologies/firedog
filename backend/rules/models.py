...
class FirewallRule(models.Model):
    ...
    chain = models.CharField(
        ...
        db_index=True,
        help_text="Chain iptables"
    )
    rule_number = models.PositiveIntegerField(
        null=True,
        blank=True,
        help_text="Numero della regola nella chain"
    )
    ...
    comment = models.CharField(
        max_length=256,
        blank=True,
        help_text="Commento descrittivo della regola"
    )
    ...
    is_synced = models.BooleanField(
        default=False,
        help_text="Indica se la regola è sincronizzata sul target"
    )
