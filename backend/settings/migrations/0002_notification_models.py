...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slack_webhook_url",
                    models.URLField(
                        blank=True, help_text="URL webhook Slack", max_length=500
                    ),
                ),
                (
                    "discord_enabled",
                ...
                (
                    "discord_webhook_url",
                    models.URLField(
                        blank=True, help_text="URL webhook Discord", max_length=500
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recipient",
                    models.CharField(
                        help_text="Destinatario (email o webhook URL)", max_length=500
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["alert_type", "sent_at"], name="notificatio_alert_t_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationlog",
            index=models.Index(
                fields=["target", "sent_at"], name="notificatio_target_idx"
            ),
        ),
    ]
