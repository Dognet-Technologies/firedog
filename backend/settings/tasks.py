...
Se ricevi questo messaggio, la configurazione è corretta!
    ...
    try:
        if notification_type == 'email':
            recipients = [test_recipient] if test_recipient else config.email_recipients[:1]
            ...
            result['details'] = {
                'webhook_url': config.slack_webhook_url[:50] + '...'
            }
            ...
            result['details'] = {
                'webhook_url': config.discord_webhook_url[:50] + '...'
            }
