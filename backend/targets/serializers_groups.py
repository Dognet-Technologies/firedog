...
class GroupRuleTemplateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'protocol', 'port', 'source_ip',
            'action', 'comment', 'priority', 'created_at'
        ]
...
class TargetGroupListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'target_count', 'online_count', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'target_count', 'online_count', 'created_at', 'updated_at']
...
class TargetGroupDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'description', 'color', 'icon',
            'targets', 'target_count', 'online_count',
            'rule_templates', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'target_count', 'online_count', 'created_at', 'updated_at']
...
class TargetGroupCreateSerializer(serializers.ModelSerializer):
    ...
    def validate_target_ids(self, value):
        ...
        if value:
            existing_ids = set(Target.objects.filter(id__in=value).values_list('id', flat=True))
